...
pub fn main() !void {
    ...
    var start_positions = std.AutoHashMap(usize, void).init(allocator);
...
fn search(x: i32, y: i32, prev_height: u8, start_positions: *std.AutoHashMap(usize, void)) !void {
    ...
    if (curr_height == trail_start) {
        try start_positions.put(index(x, y), {});
    } else {
